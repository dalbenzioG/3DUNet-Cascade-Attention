...
class cascade_unet_3D(nn.Module):
    def __init__(self, in_dim, num_classes=3, feature_scale=8):
        super(cascade_unet_3D, self).__init__()
    ...
    def forward(self, x):
        ...
        # print('down1: {}'.format(down_1.shape))
        ...
        up_9 = self.up_9(down_9, bridge2)
        # print('up_9 {}'.format(up_9.shape))
        up_8 = self.up_8(down_8, up_9)
